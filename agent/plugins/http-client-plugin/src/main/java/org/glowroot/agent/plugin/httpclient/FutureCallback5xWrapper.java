...
public class FutureCallback5xWrapper<T> implements FutureCallback<T> {

    private final FutureCallback<T> delegate;
    private final AsyncTraceEntry asyncTraceEntry;
    private final AuxThreadContext auxContext;

    public FutureCallback5xWrapper(FutureCallback<T> delegate, AsyncTraceEntry asyncTraceEntry,
    ...
    private static RuntimeException rethrow(Throwable t) {
        FutureCallback5xWrapper.<RuntimeException>throwsUnchecked(t);
