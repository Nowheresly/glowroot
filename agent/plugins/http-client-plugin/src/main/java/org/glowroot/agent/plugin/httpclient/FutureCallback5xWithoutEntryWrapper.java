...
public class FutureCallback5xWithoutEntryWrapper<T> implements FutureCallback<T> {

    private final FutureCallback<T> delegate;
    private final AuxThreadContext auxContext;

    public FutureCallback5xWithoutEntryWrapper(FutureCallback<T> delegate,
    ...
    private static RuntimeException rethrow(Throwable t) {
        FutureCallback5xWithoutEntryWrapper.<RuntimeException>throwsUnchecked(t);
